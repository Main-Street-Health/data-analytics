-- drop TABLE perm.supp_file_uhc_20230601
CREATE TABLE perm.supp_file_uhc_20230608 AS
WITH
    good_mbi                 AS
        ( SELECT
              mco_id
...
SELECT medicare_specialty_code_int FROM perm.supp_file_uhc_20230608;
alter table perm.supp_file_uhc_20230608 ALTER place_of_service type text;
alter table perm.supp_file_uhc_20230608 ALTER medicare_specialty_code_int type text;
SELECT place_of_service, count(*) FROM perm.supp_file_uhc_20230608 GROUP BY 1;