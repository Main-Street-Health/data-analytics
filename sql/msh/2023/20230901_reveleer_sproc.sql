CREATE PROCEDURE sp_reveleer_data_stager(_is_new_only bool)
------------------------------------------------------------------------------------------------------------------------
/* Stages data in the reveleer tables to generate files off off
   Reveleer files can't have new chases mixed with new information for existing chases.
   The only arg `_is_new_only` determines what is generated
*/
------------------------------------------------------------------------------------------------------------------------
    LANGUAGE plpgsql
AS
