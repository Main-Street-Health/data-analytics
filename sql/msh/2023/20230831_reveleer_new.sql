    ------------------------------------------------------------------------------------------------------------------------
    /* send new projects and new measures
     */
    ------------------------------------------------------------------------------------------------------------------------
    ------------------------------------------------------------------------------------------------------------------------
    /* add new projects */
...
--                                   measures_to_send)
--     VALUES
--         ('humana_ky', 44, 31, '1849', now(), now(),
--          '{Breast Cancer Screening,Colorectal Screening,Controlling High Blood Pressure < 140/90,Eye Exam for Patients with Diabetes,Hemoglobin A1c Control for Patients With Diabetes,Osteoporosis Management,Care for Older Adult: Pain Assessment,Care for Older Adult: Medication Review,Care for Older Adult: Functional Status Assessment}');
