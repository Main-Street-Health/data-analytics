CREATE OR REPLACE PROCEDURE sp_dpc_stage_spin_cycle()
    LANGUAGE plpgsql
AS
$$
BEGIN
...
WHERE
  ...
  AND inserted_at::DATE >= '2023-08-22'
...
select elt.dpc_eligibility_to_coop_current_coverage();
SELECT *
FROM
...
FROM
    dpoc_patients
WHERE
      mbi IN ('4UR1M45QW38', '9R14NA4GK88')
  AND source = 'member_doc';

SELECT *
FROM
    fdw_member_doc.patients p where p.id in ( 56922, 594357 ) ;

-- delete from dpoc_patients where id = 453020;