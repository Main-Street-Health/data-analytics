...
WHERE
        rp.id IN (125, 135, 245, 127, 185, 233, 30, 138, 273, 274, 275, 276)
  AND   attr.is_om
  AND   NOT EXISTS( SELECT
                    ...
                    WHERE
                          insurance_classification_id = 'om_other'
...
SELECT
    COUNT(*) n
, count(*) FILTER ( WHERE dpoc_patient_id is not null ) n_dpc
, count(*) FILTER ( WHERE _patients.bene_id is not null ) n_dpc_data_pulled
FROM
    _patients;
...
FROM
    ( VALUES
          ...
          ('01', 'Beneficiary enrolled in Parts A and/or B, and Part D; deemed eligible for LIS with 100% premium subsidy and no copayment',     '1', 'NoCostSharing'),
          ('02', 'Beneficiary enrolled in Parts A and/or B, and Part D; deemed eligible for LIS with 100% premium subsidy and low copayment',    '1', 'FBDE'),
          ('03', 'Beneficiary enrolled in Parts A and/or B, and Part D; deemed eligible for LIS with 100% premium subsidy and high copayment',   '1', 'NonFBDE'),
          ('04', 'Beneficiary enrolled in Parts A and/or B, and Part D; enrolled in LIS with 100% premium subsidy and high copayment',           '1', 'NonFBDE'),
          ('05', 'Beneficiary enrolled in Parts A and/or B, and Part D; enrolled in LIS with 100% premium subsidy and 15% copayment',            '1', 'FifteenPercentCostSharing'),
          ('06', 'Beneficiary enrolled in Parts A and/or B, and Part D; enrolled in LIS with 75% premium subsidy and 15% copayment',             '0.75', 'FifteenPercentCostSharing'),
          ...
          ('08', 'Beneficiary enrolled in Parts A and/or B, and Part D; enrolled in LIS with 25% premium subsidy and 15% copayment',             '0.25', 'FifteenPercentCostSharing'),
