CREATE TABLE bk_up.lab_corp_roster_20250331 AS
SELECT
    sp.patient_id
  , first_name
  , NULL                                                   middle_name
...
FROM
    ...
    JOIN junk.mssp_for_quest_20250328 j on j.patient_id = sp.patient_id
...
FROM
    bk_up.lab_corp_roster_20250331;