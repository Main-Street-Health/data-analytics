...
WHERE
    ndc IN (
            '50228023110',-- ENALAPRIL MALEATE 20 MG TABS
            '84386003390' -- PRAVASTATIN 40MG TABLETS
           )
;
...
INTO
    ref.med_adherence_value_sets (value_set_id, value_set_subgroup, value_set_item, code_type, code, description,
                                  ...
                                  attribute_type, attribute_value, inserted_at, updated_at, measure_version)
VALUES
    ('RENIN_ANGIOTENSIN_SYSTEM_RAS_ANTAGONISTS', 'ACE INHIBITOR MEDICATIONS', 'ENALAPRIL', 'NDC', '50228023110',
     'ENALAPRIL 20 MG TABLET', 'ORAL', 'TABLET', NULL, NULL, NULL, NULL, '1900-01-01', '2099-12-31', NULL, NULL,
     now(), now(), '2025');
...
INTO
    ref.med_adherence_value_sets (value_set_id, value_set_subgroup, value_set_item, code_type, code, description,
                                  ...
                                  attribute_type, attribute_value, inserted_at, updated_at, measure_version)
VALUES
    ('STATINS', 'STATINS', 'PRAVASTATIN', 'NDC', '84386003390', 'PRAVASTATIN 40 MG TABLET', 'ORAL', 'TABLET',
     NULL, NULL, NULL, NULL, '1900-01-01', '2099-12-31', NULL, NULL, now(),
     now(), '2025');
...
SELECT *
FROM
    fdw_member_doc.patient_medication_fills where drug_description ~* 'ENALAPRIL';


UPDATE fdw_member_doc.patient_medication_fills
SET
    measure_key = 'med_adherence_hypertension'
...
WHERE
      ndc IN (
              '50228023110'
--           ,-- ENALAPRIL MALEATE 20 MG TABS
--               '84386003390' -- PRAVASTATIN 40MG TABLETS
          )
  AND measure_key ISNULL ;
